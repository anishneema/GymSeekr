...
const MainNavigator = () => (
  ...
  >
    ...
    <Tab.Screen name="WorkoutTracker" component={WorkoutTrackerScreen} options={{ title: 'Tracker', headerShown: false }} />
    <Tab.Screen name="WorkoutLog" component={WorkoutLogScreen} options={{ title: 'Log', headerShown: false}} />
